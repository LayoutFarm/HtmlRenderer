...
namespace HtmlRenderer
{
    ...
    public static class HtmlRender
    {
        ...
        public static SizeF Measure(Graphics g, string html, HtmlContainer container,
            ...
            EventHandler<HtmlRenderer.ContentManagers.HtmlImageRequestEventArgs> imageLoad = null)
        {
        ...
        public static SizeF Render(Graphics g, string html, float left = 0, float top = 0, float maxWidth = 0, CssActiveSheet cssData = null,
                                   EventHandler<HtmlStylesheetLoadEventArgs> stylesheetLoad = null, EventHandler<HtmlRenderer.ContentManagers.HtmlImageRequestEventArgs> imageLoad = null)
        {
        ...
        private static SizeF Measure(Graphics g, string html,
            ...
            EventHandler<HtmlStylesheetLoadEventArgs> stylesheetLoad, EventHandler<HtmlRenderer.ContentManagers.HtmlImageRequestEventArgs> imageLoad)
        {
        ...
        private static SizeF RenderClip(Graphics g, string html, PointF location, SizeF maxSize, CssActiveSheet cssData,
            ...
            EventHandler<HtmlRenderer.ContentManagers.HtmlImageRequestEventArgs> imageLoad)
        {
