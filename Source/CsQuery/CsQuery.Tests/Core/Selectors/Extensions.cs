...
namespace CsQuery.Tests.Core.Selectors
{
    ...
    public class Extensions: CsQueryTest
    {
        ...
        public void SimpleExtension()
        {
            ...
            CsQuery.Config2.PseudoClassFilters.Register("isnumeric", typeof(ContentIsNumeric));
        ...
        {
            var dom = TestDom("TestHtml");
            CsQuery.Config2.PseudoClassFilters.Register("is-child-of-type", typeof(IsChildOfTag));
