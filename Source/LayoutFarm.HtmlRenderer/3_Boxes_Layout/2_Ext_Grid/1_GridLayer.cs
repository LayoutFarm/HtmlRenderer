...
namespace LayoutFarm.HtmlBoxes
{
    ...
    sealed class GridLayer
    {
        ...
        public GridLayer(LayoutBox owner, int nColumns, int nRows, CellSizeStyle cellSizeStyle)
        {
            ...
            int columnWidth = (int)owner.SizeWidth;
            if (nColumns > 0)
            {
            ...
            if (nRows > 0)
            {
                int rowHeight = (int)(owner.SizeHeight / nRows);
                int cy = 0;
        ...
        //public bool HitTestCore(CssBoxHitChain hitChain)
        //{
        //    int testX;
        //    int testY;
        ...
        public void DrawChildContent(Canvas canvas, Rectangle updateArea)
        {
        ...
        void FinishDrawingChildContent()
        {
