...
namespace HtmlRenderer
{
    ...
    {
        public static void SetHtml(this MyHtmlRenderBoxImpl container, string html, CssActiveSheet cssData)
        {
            ...
            var rootBox = builder.BuildCssTree(htmldoc,
                ...
                container, cssData);
            MyHtmlRenderBoxImpl containerImp = container as MyHtmlRenderBoxImpl;
        ...
        public static void SetHtml(this MyHtmlRenderBoxImpl container, HtmlRenderer.WebDom.WebDocument doc, CssActiveSheet cssData)
        {
            HtmlRenderer.Composers.BoxModelBuilder builder = new Composers.BoxModelBuilder();
            builder.RequestStyleSheet += (e) =>
            {
        ...
        public static void RefreshHtmlDomChange(this MyHtmlRenderBoxImpl container,
            HtmlRenderer.WebDom.WebDocument doc, CssActiveSheet cssData)
        {

            PartialRebuildCssTree(container, doc);
        }
        static void FullRebuildCssTree(MyHtmlRenderBoxImpl container,
        ...
        static void PartialRebuildCssTree(MyHtmlRenderBoxImpl container,
            HtmlRenderer.WebDom.WebDocument doc)
        {
            HtmlRenderer.Composers.BoxModelBuilder builder = new Composers.BoxModelBuilder();
            builder.RequestStyleSheet += (e) =>
