...
namespace HtmlRenderer.Dom
{
    ...
    public static class BoxCreator
    {
        ...
        static CssBox CreateTableColumnOrColumnGroup(CssBox parent, BridgeHtmlElement childElement)
        {
            CssBox col = new CssBox(parent, childElement, childElement.Spec);
        ...
        static CssBox CreateTableCell(CssBox parent, BridgeHtmlElement childElement)
        {
            CssBox tableCell = new CssBox(parent, childElement, childElement.Spec);
        ...
        internal static CssBox CreateBox(CssBox parentBox, BridgeHtmlElement childElement)
        {
            ...
            switch (childElement.WellknownTagName)
            {
                ...
                case WellknownHtmlTagName.th:
                    return CreateTableCell(parentBox, childElement);
                case WellknownHtmlTagName.col:
                case WellknownHtmlTagName.colgroup:
                    return CreateTableColumnOrColumnGroup(parentBox, childElement);
                //---------------------------------------------------
                //test extension box
