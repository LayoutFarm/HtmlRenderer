...
namespace HtmlRenderer.Dom
{
    ...
    public sealed class CssBoxFrame : CssBox
    {
        ...
        internal CssBoxFrame(CssBox parent, BridgeHtmlElement tag, Css.BoxSpec spec)
        ...
        private bool IsLayoutRequired()
        {
            ...
            return (width.Number <= 0 || width.UnitOrNames != Css.CssUnitOrNames.Pixels) ||
                (height.Number <= 0 || height.UnitOrNames != Css.CssUnitOrNames.Pixels);
        }
