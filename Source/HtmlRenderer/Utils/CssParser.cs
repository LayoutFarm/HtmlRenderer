...
namespace HtmlRenderer.Parse
{
    ...
    public static class CssParser
    {
        ...
        //{
        //    var parser = new WebDom.Parser.CssParser();
        //    WebDom.CssRuleSet codeBlock = parser.ParseCssPropertyDeclarationList(blockSource.ToCharArray());
        ...
        //    //return null;
        //}
        ////private static CssCodeBlock ParseCssBlockImp2(string className, string blockSource)
        //{
        //    className = className.ToLower();
        //    string psedoClass = null;
        //    var colonIdx = className.IndexOf(":", StringComparison.Ordinal);
        ...
        //        case "border-style":
        //            {
        //                SetAllBorderStyleProperty(propValue, properties);
        //            } break;
        //        case "border-width":
        //            {
        //                SetAllBorderWidthProperty(propValue, properties);
        //            } break;
        //        case "border-color":
        //            {
        //                SetAllBorderColorProperty(propValue, properties);
        //            } break;
        //        case "padding":
        //            {
        ...
        ///// <param name="propValue">the value of the css property to add</param>
        ///// <param name="properties">the properties collection to add to</param>
        //static void ParseLengthProperty(string propName, string propValue, Dictionary<string, CssProperty> properties)
        //{
        ...
        //    else
        //    {
        //        //if no direction then expand to all
        //        if (borderWidth != null) SetAllBorderWidthProperty(borderWidth, properties);
        //        if (borderStyle != null) SetAllBorderStyleProperty(borderStyle, properties);
        //        if (borderColor != null) SetAllBorderColorProperty(borderColor, properties);
        //    }
        //}
        ...
        ///// <param name="propValue">the value of the property to parse to specific values</param>
        ///// <param name="properties">the properties collection to add the specific properties to</param>
        //private static void SetAllBorderStyleProperty(string propValue, Dictionary<string, CssProperty> properties)
        //{
        //    string bottom, top, left, right;
        //    SplitMultiDirectionValues(propValue, out left, out top, out right, out bottom);
        ...
        ///// <param name="propValue">the value of the property to parse to specific values</param>
        ///// <param name="properties">the properties collection to add the specific properties to</param>
        //private static void SetAllBorderWidthProperty(string propValue, Dictionary<string, CssProperty> properties)
        //{
        //    string bottom, top, left, right;
        //    SplitMultiDirectionValues(propValue, out left, out top, out right, out bottom);
        ...
        ///// <param name="propValue">the value of the property to parse to specific values</param>
        ///// <param name="properties">the properties collection to add the specific properties to</param>
        //private static void SetAllBorderColorProperty(string propValue, Dictionary<string, CssProperty> properties)
        //{
        //    string bottom, top, left, right;
        //    SplitMultiDirectionValues(propValue, out left, out top, out right, out bottom);
