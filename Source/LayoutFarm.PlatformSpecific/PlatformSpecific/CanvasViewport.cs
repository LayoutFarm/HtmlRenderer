...
namespace LayoutFarm.Presentation
{
    ...
    public partial class CanvasViewport
    {
        ...
        void PaintMe()
        {
            ...
            if (VisualWindowImpl.dbugVE_HighlightMe != null)
            {
                outputWindow.dbug_HighlightMeNow(VisualWindowImpl.dbugVE_HighlightMe.GetGlobalRect());
