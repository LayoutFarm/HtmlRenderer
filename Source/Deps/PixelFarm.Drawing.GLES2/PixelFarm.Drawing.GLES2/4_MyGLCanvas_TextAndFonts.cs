...
namespace PixelFarm.Drawing.GLES2
{
    partial class MyGLCanvas
    {
        ...
        {
            painter1.TextPrinter.DrawString(buffer, x, this.Height - y);
        ...
        {
            //TODO: review again
            painter1.TextPrinter.DrawString(buffer, logicalTextBox.X, this.Height - logicalTextBox.Y);
            //var tmpColor = this.internalSolidBrush.Color;
            //internalSolidBrush.Color = this.currentTextColor;
            //gx.DrawString(new string(buffer),
            //    (System.Drawing.Font)this.currentTextFont.InnerFont,
        ...
        {
            //TODO: review again
            painter1.TextPrinter.DrawString(str, logicalTextBox.X, this.Height - logicalTextBox.Y);
            //TODO: review here
